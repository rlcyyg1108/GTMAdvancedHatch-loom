...
public class AdaptiveNetLaserHatchPartMachine extends NetLaserHatchPartMachine implements IFrequency, INetEndpoint {

    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(AdaptiveNetLaserHatchPartMachine.class, NetLaserHatchPartMachine.MANAGED_FIELD_HOLDER);
    // 判断是否可以连接
    @Persisted
